...
class InvertedResidualDW(nn.Module):
    def __init__(self, channels, expand_ratio=2, inplace=False, kernel_size=3):
        super().__init__()
        ...
        self.block = nn.Sequential(
            ...
            # 高维空间提取空间/时域特征
            nn.Conv2d(hidden_dim, hidden_dim, kernel_size, padding=kernel_size//2, groups=hidden_dim),
            nn.LeakyReLU(inplace=inplace),
            # 降维恢复，通常这里不用激活函数(线性瓶颈)
